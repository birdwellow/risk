...
return [
	...
	*/
        ...
        'thread.nousersadded' => "Es konnten keine User hinzugef&uuml;gt werden.",
    
        'create.match.wrong.parameters' => "Das Match konnte nicht erstellt werden. Bitte korrigiere deine Eingaben.",
