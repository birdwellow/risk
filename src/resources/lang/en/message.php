...
return [
	...
	*/
	...
	'link.password.forgotten' => "Forgot Your Password?",
        ...
        'link.suggestion.create.thread' => "Create a new Thread & write a message",
        ...
        'title.new.messages' => "New messages in :number threads",
        'title.new.message' => "New message in a thread",
        'title.message.firstthreadmessage' => "First message",
    
    
        'text.no.new.messages' => "No new messages.",
        'text.no.messages' => "No messages.",
        'text.no.thread.selected' => "No thread selected.",
