...
return [
	...
	*/
	...
	"reset" => "Your password has been reset!",
        ...
        "resetemail.subject" => "Your Password Reset Link",
        "resetemail.body.header" => "Your Password Reset",
        "resetemail.body.salutation" => "Hello,",
        "resetemail.body.requested" => "You requested a password reset link by e-mail.",
